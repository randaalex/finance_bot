...
// ObjectGroupArray struct for ObjectGroupArray
...
func (o ObjectGroupArray) MarshalJSON() ([]byte, error) {
...
type NullableObjectGroupArray struct {
	value *ObjectGroupArray
	isSet bool
}

func (v NullableObjectGroupArray) Get() *ObjectGroupArray {
	return v.value
}

func (v *NullableObjectGroupArray) Set(val *ObjectGroupArray) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectGroupArray) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectGroupArray) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectGroupArray(val *ObjectGroupArray) *NullableObjectGroupArray {
	return &NullableObjectGroupArray{value: val, isSet: true}
}

func (v NullableObjectGroupArray) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectGroupArray) UnmarshalJSON(src []byte) error {
	v.isSet = true
